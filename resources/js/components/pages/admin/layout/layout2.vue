                ...
                <div class="adjust-nav">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <img
                                src="../../../../assets/admin/assets/img/logo.png"
                            />
                        </a>
                    </div>
...
<style scoped>
@import "../../../../assets/admin/assets/css/bootstrap";
@import "../../../../assets/admin/assets/css/font-awesome";
@import "../../../../assets/admin/assets/css/custom";
</style>

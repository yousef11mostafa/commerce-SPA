          ...
          <div class="card-body">
            ...
            <form @submit.prevent="register()">
              ...
              <div class="mb-3">
                ...
                <input type="address" class="form-control" id="address" placeholder="Enter your email"  v-model="data.address">
                  <p v-if="errors && errors.address" class="text-danger">{{errors.address[0]}}</p>
              </div>
              <div class="mb-3">
                <label for="state" class="form-label">State</label>
                <input type="state" class="form-control" id="state" placeholder="Enter your state"  v-model="data.state">
                  <p v-if="errors && errors.state" class="text-danger">{{errors.state[0]}}</p>
              </div>
              <div class="mb-3">
                <label for="city" class="form-label">City</label>
                <input type="city" class="form-control" id="city" placeholder="Enter your city"  v-model="data.city">
                  <p v-if="errors && errors.city" class="text-danger">{{errors.city[0]}}</p>
              </div>
              <div class="mb-3">
                <label for="zip_code" class="form-label">Zip_code</label>
                <input type="zip_code" class="form-control" id="zip_code" placeholder="Enter your zip_code"  v-model="data.zip_code">
                  <p v-if="errors && errors.zip_code" class="text-danger">{{errors.zip_code[0]}}</p>
              </div>
              <div class="mb-3">
